...
inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 14000; }
inline bool IsProtocolV3(int nHeight) { return TestNet() || nHeight > 20000; }
...
static const unsigned int MN_START_TIMESTAMP = 1538323200;
