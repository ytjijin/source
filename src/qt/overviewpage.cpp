...
void OverviewPage::updateDarksendProgress()
{
    ...
    QString strAnonymizeYTGMAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeYTGMAmount * COIN, false, BitcoinUnits::separatorAlways);
...
//        strAnonymizeYTGMAmount = strAnonymizeYTGMAmount.remove(strAnonymizeYTGMAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAnonymizeYTGMAmount = strAnonymizeYTGMAmount.remove(strAnonymizeYTGMAmount.indexOf("."), 2 + 1);
        strAmountAndRounds = strAnonymizeYTGMAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    ...
    if(nMaxToAnonymize > nAnonymizeYTGMAmount*COIN) nMaxToAnonymize = nAnonymizeYTGMAmount*COIN;

    if(nMaxToAnonymize == 0) return;

    if(nMaxToAnonymize >= nAnonymizeYTGMAmount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                          .arg(strAnonymizeYTGMAmount));
//        strAnonymizeYTGMAmount = strAnonymizeYTGMAmount.remove(strAnonymizeYTGMAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAnonymizeYTGMAmount = strAnonymizeYTGMAmount.remove(strAnonymizeYTGMAmount.indexOf("."), 2 + 1);
        strAmountAndRounds = strAnonymizeYTGMAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    } else {
