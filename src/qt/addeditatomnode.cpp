...
void AddEditAtomNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText(tr("Please enter an alias."));
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText(tr("Please enter an ip address and port. (123.45.67.89:15200)"));
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText(tr("Please enter a masternode private key. This can be found using the \"masternode genkey\" command in the console."));
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText(tr("Please enter the transaction hash for the transaction that has 20,000 coins"));
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText(tr("Please enter a transaction output index. This can be found using the \"masternode outputs\" command in the console."));
        msg.exec();
        return;
    }
    else
